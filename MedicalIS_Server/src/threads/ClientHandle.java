...
public class ClientHandle extends Thread {
    ...
    private  synchronized Response loginLekar(Request request) {
    ...
    private  synchronized Response sendKartonPacijenta(Request request) {
        Response response = new Response();
    ...
    private  synchronized Response sendRezultati(Request request) {
        Response response = new Response();
    ...
    private  synchronized Response loginLab(Request request) {
        Response response = new Response();
    ...
    private  synchronized Response findKartonPacijenta(Request request) {
        Response response = new Response();
        response.setOperation(Operations.GET_PACIJENT);
        try {
    ...
    private  synchronized Response sendAllUputi() {
        Response response = new Response();
    ...
    private  synchronized Response insertRezultat(Request request) {
