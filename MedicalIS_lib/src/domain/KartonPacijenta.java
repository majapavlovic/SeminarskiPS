...
public class KartonPacijenta implements Serializable, GeneralDObject{
    ...
    public KartonPacijenta(Long jmbg, Long lbo, String ime, String prezime, Pol pol, Date datumRodjenja, String adresa, String kontaktTelefon, String krvnaGrupa, String hronicneDijagnoze, Lekar lekar) {
        this.jmbg = jmbg;
        this.lbo = lbo;
        this.ime = ime;
